                ...
                <div class="container">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <form action="<?= base_url('caja_general/todos_los_cierres_caja_general') ?>" method="GET">
                                    <button type="submit" class="btn bg-green-lt btn-icon">Consultar otros cierres</button>
                                </form>
                            </td>
                        </tr>
                    </table>
...
<?= $this->include('caja_general/modal_total_ingresos') ?>
<?= $this->include('caja_general/modal_retiros') ?>
<?= $this->include('caja_general/modal_editar_apertura') ?>
<?= $this->include('caja_general/modal_editar_cierre') ?>
