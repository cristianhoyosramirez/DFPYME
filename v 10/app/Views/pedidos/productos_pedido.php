                ...
                <?php if ($id_tipo['fk_tipo_empresa'] == 1) : ?>
                    ...
                    <div class="row align-items-start border rounded mb-3 p-2">
                        ...
                        <div class="col-12 col-lg-3">
                            ...
                            <?php endif ?>
                            <!--  <div class="fw-bold"><?= $detalle['nombreproducto']; ?></div> -->
                            ...
                            <div class="text-primary fw-bold small" id="atributos<?= $detalle['id_tabla_producto'] ?>">
                                ...
                                ?>
                                        <p style="margin: 2px 0;">
                                            <span style="color: green; font-weight: bold;"><?= $nombreAtributo['nombre']; ?></span>
                                            <?php if (!empty($componentes)): ?>
                                                (<span style="color: black;"><?= implode(', ', array_column($componentes, 'nombre')); ?></span>)
                                            <?php else: ?>
                        ...
                        <div class="col-6 col-lg-3">
                            <label class="small d-lg-none">Cantidad:</label>
                        ...
                        <div class="col-12 col-lg-4 mt-3 mt-lg-0 d-flex justify-content-between align-items-start flex-column flex-lg-row">
                            <div>
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown border-none ">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <?php $motrarBotonMitad = model('configuracionPedidoModel')->select('mostrar_boton_mitad')->first(); ?>

                                        <?php if ($motrarBotonMitad['mostrar_boton_mitad'] == 't'): ?>
                                        ...
                                        <?php if ($user_session->tipo == 0 or $user_session->tipo == 1 or $user_session->tipo == 4 or $user_session->tipo == 5):  ?>
                                            ...
                                            <li><a class="dropdown-item" href="#" onclick="dineroDescuento(<?php echo $detalle['id_tabla_producto']; ?>,<?php echo $detalle['valor_unitario']; ?>)"><!-- Download SVG icon from http://tabler-icons.io/i/currency-dollar -->
