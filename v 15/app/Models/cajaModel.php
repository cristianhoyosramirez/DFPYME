...
class cajaModel extends Model
{
    ...
    protected $allowedFields = ['numerocaja', 'estado', 
    'consecutivo','requiere_lista_de_precios','imp_comprobante_transferencia','consecutivo_factura_electronica','id_impresora'];
