                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        <input type="date" class="form-control" id="fecha_inicial"
                            value="<?php echo date('Y-m-d'); ?>" name="fecha_inicial">
                        <button class="btn btn-outline-secondary" type="button"
                            onclick="limpiar_campo('fecha_inicial')" title="Limpiar">
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group">
                        <input type="date" class="form-control" id="fecha_final"
                            value="<?php echo date('Y-m-d'); ?>" name="fecha_final">
                        <button class="btn btn-outline-secondary" type="button"
                            onclick="limpiar_campo('fecha_final')" title="Limpiar">
