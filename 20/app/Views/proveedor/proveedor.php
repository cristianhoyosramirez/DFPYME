                        ...
                        <div class="container "><br>
                            <div class="row mb-3">
                                <div class="col mb-3">
                                    ...
                                    <input type="text" id="nit" class="form-control" oninput="this.classList.remove('is-invalid')" autofocus onkeyup="(saltar_factura_pos(event,'nombre'))">
                                </div>
                                <div class="col mb-3">
                                    <label for="nombre" class="form-label">Nombre</label>
                                    <input type="text" id="nombre" class="form-control"oninput="this.classList.remove('is-invalid')" onkeyup="(saltar_factura_pos(event,'direccion'))">
                                </div>
                                <div class="col mb-3">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <input type="text" id="telefono" class="form-control"oninput="this.classList.remove('is-invalid')" onkeyup="(saltar_factura_pos(event,'crearBtn'))">
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <input type="text"
                                        ...
                                        autofocus
                                        onkeyup="saltar_factura_pos(event,'edicion_nombre')">
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <input type="text"
                                        id="edicion_nombre"
                                        class="form-control input-validar"
                                        onkeyup="saltar_factura_pos(event,'edicion_direccion')">
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <input type="text"
                                        id="edicion_direccion"
                                        class="form-control input-validar"
                                        onkeyup="saltar_factura_pos(event,'edicion_telefono')">
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <input type="text"
                                        id="edicion_telefono"
                                        class="form-control input-validar"
                                        onkeyup="saltar_factura_pos(event,'btnGuardarProveedor')">
...
<script>
    document.addEventListener('input', function(e) {
        if (e.target.classList.contains('input-validar')) {
                    ...
                    <div class="row">
                        <div class="col">
                            <button onclick="editar_proveedor(${resultado.id})" class="btn btn-outline-success">Editar</button>
                                                       <button onclick="eliminar_proveedor(${resultado.id}, '${resultado.nombre}')" class="btn btn-outline-danger">
    Eliminar
</button>
                        </div>
                    </div>
