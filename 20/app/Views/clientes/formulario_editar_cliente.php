    ...
    <div class="col-md-3">
        ...
        <?php if ($tieneMovimiento): ?>
            <small class="text-warning">
                No se puede editar el NIT porque tiene facturas registradas en la DIAN.
            </small>
        <?php endif; ?>
    </div>
    ...
    <div id="tipoPersona">
        ...
        <?php if ($datos_cliente['type_person'] == 1): ?>
            <div class="col-md-12">
                ...
                <input type="text"
                    class="form-control"
                    id="razon_social_edicion"
                    name="razon_social_edicion"
                    value="<?php echo $datos_cliente['nombrescliente'] ?>"
...
<script>
    $("#ciudad_cliente_edicion").select2({
        width: "100%",
...
<script>
    $(document).ready(function() {
        ...
        $('#edicion_cliente_electronico').on('submit', function(e) {
            e.preventDefault();
                ...
                success: function(data) {
                    ...
                    if (!$.isEmptyObject(data.error)) {
                        ...
                        $.each(data.error, function(prefix, val) {
                            $(form).find('.' + prefix + '_error').text(val);
                        });
                    ...
                    //location.reload();
                    let modalEl = document.getElementById('editar_cliente');
                    ...
                    Swal.fire({
                        ...
                        title: (data.code == 1) ? 'Correcto' : 'Atención',
                        text: data.msg,
                        confirmButtonText: 'Aceptar',
                        timer: 1500, // ⏱️ se cierra en 1.5 segundos
