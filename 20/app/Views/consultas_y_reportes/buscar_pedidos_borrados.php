...
<div class="card container">
    ...
    <div class="card-body">
        ...
        <form action="<?php echo base_url() ?>/caja_general/exportPedidosBorrados" method="POST">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <input type="date"
                        ...
                        name="fecha_inicial"
                        id="fecha_inicial">
                    <span class="text-danger small" id="error_fecha_inicial"></span>
                </div>
                ...
                <div class="col-6 col-md-2 d-grid">
                    <button type="button"
                        ...
                        onclick="buscar_pedidos_borrados()">
                        Buscar
                    </button>
                </div>
