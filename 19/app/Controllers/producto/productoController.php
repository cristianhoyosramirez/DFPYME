...
class productoController extends BaseController
{
    ...
    function index()
    {
        ...
        $sql_data .= " ORDER BY nombreproducto ASC LIMIT " . $_POST['length'] . " OFFSET " . $_POST['start'];
        ...
        if (!empty($datos)) {
            foreach ($datos as $detalle) {
                ...
                $tipoInvetario = model('tipoInventarioModel')->select('abreviacion')->where('id', $detalle['id_tipo_inventario'])->first();

                $sub_array = array();
                //$sub_array[] = $tipoInvetario['nombre'];
                $nombreCompleto = $tipoInvetario['abreviacion'];
