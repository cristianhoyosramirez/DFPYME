...
<div class="container my-4">
    ...
    <div class="container">
        ...
        <div class="accordion" id="accordionGestionFacturas">

            <div class="accordion-item">

                <h2 class="accordion-header" id="headingGestionFacturas">
                    <button class="accordion-button collapsed" type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collapseGestionFacturas"
                        aria-expanded="false"
                        aria-controls="collapseGestionFacturas">
                        Ver eliminación prefactura
                    </button>
                </h2>

                <div id="collapseGestionFacturas"
                    class="accordion-collapse collapse"
                    aria-labelledby="headingGestionFacturas"
                    data-bs-parent="#accordionGestionFacturas">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select id="obligar_justificacion_producto" class="form-select"
                                    onchange="actualizarPrefactura(this.value)">

                                    <option value="false" <?= $prefactura === 'f' ? 'selected' : '' ?>>No</option>
                                    <option value="true" <?= $prefactura === 't' ? 'selected' : '' ?>>Sí</option>
...
<script>
    async function actualizarPrefactura(valor) {



        try {
            const response = await fetch("<?= base_url('actualizacion/actualizarPrefactura') ?>", {
                method: "POST",
                headers: {
