...
<div class="container">
    ...
    <div class="row mb-3">
        ...
        <div class="col-4">
            <div class="accordion" id="accordionJustificacion">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingJustificacion">
                        <button class="accordion-button collapsed" type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapseJustificacion"
                            aria-expanded="false"
                            aria-controls="collapseJustificacion">
                            Obligar justificación al eliminar pedido
                        </button>
                    </h2>

                    <div id="collapseJustificacion" class="accordion-collapse collapse"
                        aria-labelledby="headingJustificacion"
                        data-bs-parent="#accordionJustificacion">

                        <div class="accordion-body">
                            <div class="row">
                                <div class="col">
                                    <label for="obligar_justificacion" class="form-label">
                                        ¿Desea obligar justificación al eliminar un pedido?
                                    </label>

                                    <select id="obligar_justificacion" class="form-select"
                                        onchange="actualizarJustificacionPedido(this.value)">
                                        <option value="f" <?= $justificacionPedido === 'f' ? 'selected' : '' ?>>No</option>
                                        <option value="t" <?= $justificacionPedido === 't' ? 'selected' : '' ?>>Sí</option>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row mb-3">
        <div class="col-4">
            <div class="accordion" id="accordionEliminarProducto">
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingEliminarProducto">
                        <button class="accordion-button collapsed" type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapseEliminarProducto"
                            aria-expanded="false"
                            aria-controls="collapseEliminarProducto">
                            Obligar justificación al eliminar producto
                        </button>
                    </h2>

                    <div id="collapseEliminarProducto" class="accordion-collapse collapse"
                        aria-labelledby="headingEliminarProducto"
                        data-bs-parent="#accordionEliminarProducto">

                        <div class="accordion-body">
                            <div class="row">
                                <div class="col">
                                    <label for="obligar_justificacion_producto" class="form-label">
                                        ¿Desea obligar justificación al eliminar un producto?
                                    </label>

                                    <select id="obligar_justificacion_producto" class="form-select"
                                        onchange="actualizarJustificacionProducto(this.value)">

                                        <option value="f" <?= $justificacionProducto === 'f' ? 'selected' : '' ?>>No</option>
                                        <option value="t" <?= $justificacionProducto === 't' ? 'selected' : '' ?>>Sí</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<script>
    async function actualizarJustificacionPedido() {
        ...
        try {
            const response = await fetch("<?= base_url('actualizacion/actualizarJustificacionPedido') ?>", {
                method: "POST",
                headers: {
