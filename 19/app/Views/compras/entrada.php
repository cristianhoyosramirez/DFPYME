...
<script>
    let procesandoEntrada = false; // 🔒 Evita ejecuciones simultáneas
    ...
    function entrada_inventario() {
        ...
        $.ajax({
            ...
            success: function(resultado) {
                ...
                if (data.resultado == 1) {
                    despues_de_resultado(data.productos, data.total_articulos, data.total);
    ...
    // 🔓 Libera bloqueo y re-activa el botón
    function liberarBloqueo() {
        procesandoEntrada = false;
        document.getElementById("btnCompra").disabled = false;
    }

    // 🚫 Evita que Enter dispare múltiples veces la función
