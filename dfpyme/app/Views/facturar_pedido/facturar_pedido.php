...
<div class="card container">
    <div class="card-body">
        ...
        <input type="hidden" value="<?php echo $pedido ?>" id="numero_de_facturacion" name="url">
                                    ...
                                    <td class="strong text-end">
                                        <div class="row g-2 align-items-center mb-n3">
                                            <div class="col-4 col-sm-4 col-md-2 col-xl-auto mb-3">
                                                <a href="#" title="Editar" onclick="editar_datos_producto(<?php echo $detalle['id'] ?>)" class="btn btn-warning btn-icon w-100">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-1">
                    <input type="text" class="form-control" id="valor_descuento%" onkeyup="descuento_de_factura(this.value)" value=0>
                </div>
                <div class="col-2">
                    <input type="text" class="form-control" readonly id="total_descuento%" value=0>
                </div>
                <div class="col">
                    <select class="form-select" id="descuento_propina">
                        <option disabled selected>Propina </option>
                ...
                <div class="col-1">
                    <input type="text" class="form-control" id="valor_descuento_propina" onkeyup="propina_descuento(this.value)" value=0>
                </div>
                <div class="col">
        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div style="width:17%">
                    <input type="hidden" value="<?php echo $numero_de_pedido ?>" name="numero_pedido_imprimir_comanda" id="numero_pedido_imprimir_comanda">
