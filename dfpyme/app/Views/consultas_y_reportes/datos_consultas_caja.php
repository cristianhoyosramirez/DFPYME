                ...
                <div class="row g-1">
                    ...
                    <div class="col-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-5">
                                <div class="input-group mb-3">
                                    ...
                                    <button type="button" class="btn bg-blue-lt btn-icon" onclick="editar_valor_cierre_transferencias(<?php echo $id_apertura ?>)" title="Ver todos los ingresos" title="Ver todos los retiros realizados"><!-- Download SVG icon from http://tabler-icons.io/i/pencil -->
                                        <!-- Download SVG icon from http://tabler-icons.io/i/pencil -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                            <path d="M4 20h4l10.5 -10.5a1.5 1.5 0 0 0 -4 -4l-10.5 10.5v4" />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="colFormLabel" value="<?php echo $diferencia ?>" readonly>
                            </div>
                        </div>
                    </div>
                </div>
