            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form>
                  ...
                  <!--  <div class="row mb-2">
                    ...
                    <div class="col-7">
                      <label class="form-selectgroup-item flex-fill">
                        <input type="radio" name="form-payment" id="radio_efectivo" value="bitpay" class="form-selectgroup-input" checked />
                  ...
                  <!-- <div class="col-7">
                      <div class="input-group mb-3">
                        <label class="input-group-text" for="inputGroupSelect01">Transac</label>
                        <select class="form-select" id="inputGroupSelect01">
                          <option selected>Tarjeta crédito</option>
                          <option value="1">Nequi</option>
                          <option value="2">Código Qr </option>
                          <option value="3">Daviplata </option>
                          <option value="3">sistecrédito</option>
                        </select>
                      </div>
                    </div> -->
 ...
 -->
                ...
                <!--   <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <?php $formas_pago = model('formaPagoModel')->where('aplica', 'true')->findAll(); ?>

                    <div style="height: 40vh; overflow-y: auto;">
                      <?php foreach ($formas_pago as $detalle): ?>
                          ...
                          <div class="input-group mb-2">
                            <span class="input-group-text">
                              <img data-bs-toggle="tooltip"
                                ...
                                title="<?php echo $detalle['nombreforma_pago']; ?>"
                                src="../Assets/img/<?php echo $detalle['ruta']; ?>"
                                width="110"
                                height="32"
                                alt="Macondo"
                                class="img-fluid navbar-brand-image cursor-pointer">
                            </span>
                            <input type="text" class="form-control" placeholder="<?php echo $detalle['nombreforma_pago']; ?>" id="<?php echo $detalle['idforma_pago'] ?>" autocomplete="off">
                          </div>
                        </div>
                      <?php endforeach; ?>
                    </div>
                  ...
                  <div class="row mb-2">
                    <div class="col-sm-12 text-center">
                      ...
                      <input type="hidden" id="transaccion" value=0>
          ...
          <div class="col-4 row-cards">
            <div class="card">
              ...
              <div class="card-body">
                <p class="text-primary text-center h3">Resumen de pago </p>

                <hr>
                <div class="row">
                  <div class="col-6  fw-bold">TOTAL PAGO:</div>
                  <div class="col-6 text-end">60.000</div>
                </div>
                <div class="row">
                  <div class="col-6  fw-bold">FALTANTE:</div>
                  <div class="col-6 text-end">60.000</div>
                </div>
                <div class="row">
                  <div class="col-6  fw-bold">CAMBIO:</div>
                  <div class="col-6 text-end">60.000</div>
                </div>
