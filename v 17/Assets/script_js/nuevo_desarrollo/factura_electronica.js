    ...
    $.ajax({
        ...
        .then(function (data) {
            ...
            if (estadoLicencia === "En Mora") {
                ...
                Swal.fire({
                    icon: 'warning',
                    //title: 'Estado de trasmisión de documentos electrónicos  salto de linea  estado '+ estadoLicencia,
                    title: 'Estado de consumo: \nEstado: ' + estadoLicencia,
                    text: data.mensaje,
                    ...
                    $.ajax({
                        ...
                        success: function (resultado) {
                            ...
                            if (resultado.resultado == 0) {
                                Swal.fire({
                                    icon: "error",
                                    title: "El almacenamiento de la información fallo, comuniquese con el área de soporte técnico.    ",
                                    confirmButtonText: "Aceptar",
                                    confirmButtonColor: "#2AA13D",
                                });
                            }
