    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php if ($user_session->tipo == 1 || $user_session->tipo == 0 || $user_session->tipo == 4 || $user_session->tipo == 5) { ?>
                ...
                <div class="row" id="descuento_porcentaje" style="display:none">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-12 col-lg-6 ">
                            <div class="input-group">
                                ...
                                <input type="text" id="valorReferencia" hidden>
                                <input type="number"
                                    ...
                                    min="1"
                                    max="99"
                                    oninput="this.value = this.value.replace(/^0+/, '').slice(0, 2); calcular_porcentaje(this.value)">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-2 col-6 mb-2">
                            <a href="#" class="btn btn-outline-success w-100" onclick="confirmarDescuento()">
                                Confirmar
                            </a>
                        </div>
                        <div class="col-md-2 col-6 mb-2">
                            <a href="#" class="btn btn-outline-warning w-100" onclick="restablecerPrecio()">
                                Restablecer precio
                            </a>
                        </div>
                        <div class="col-md-2 col-6 mb-2">
