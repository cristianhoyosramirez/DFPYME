...
class prefacturaController extends BaseController
{
    ...
    function ingresarInv()
    {
        ...
        if (!empty($verficar)) {
            ...
            $cantidaInventario = model('inventarioModel')->select('cantidad_inventario')->where('codigointernoproducto', $codigo['codigointernoproducto'])->first();
            ...
            $data = [
                ...
                'hora' => date('H:i:s'),
                'id_concepto' => 31,
                'inventario_anterior' => $cantidaInventario['cantidad_inventario'],
                'inventario_actual' => $cantidaInventario['cantidad_inventario'] - $cantidad
            ];

            $entradasSalidas = model('EntradasSalidasManualesModel')->insert($data);
            ...
            return $this->response->setJSON([
                ...
                'productos' => view('inventarios/productosInventario', [
