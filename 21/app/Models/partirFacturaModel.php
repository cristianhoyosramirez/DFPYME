...
class partirFacturaModel extends Model
{
    ...
    public function total_producto($id)
    {
        $datos = $this->db->query("
            select  valor_unitario * cantidad_producto as total from partir_factura  where id=$id
        ");
        return $datos->getResultArray();
    }
    ...
    {
        $datos = $this->db->query("
            select  valor_unitario * cantidad_producto as total from partir_factura
        ");
        return $datos->getResultArray();
    }
}
