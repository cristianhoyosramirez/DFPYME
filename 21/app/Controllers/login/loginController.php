            ...
            if ($usuario) {
                ...
                if (in_array($usuario[0]['idtipo'], [0, 1, 3, 4, 5])) {
                    ...
                    switch ($estado) {
                        ...
                        case 'En Mora':
                            $mensajeLicencia = model('licenciaModel')
                                ->select('mensaje_licencia, estado_licencia')
                                ->first();

                            session()->setFlashdata([
                                'iconoMensaje' => 'warning',
                                'estado'       => $mensajeLicencia['estado_licencia'],
                                'mensaje'      => $mensajeLicencia['mensaje_licencia']
                            ]);
                        ...
                        case 'Inactiva':
                            ...
                            session()->setFlashdata([
                                'iconoMensaje' => 'error',
                                'estado'       => 'Estado licencia: ' . $mensajeLicencia['estado_licencia'],
                                'mensaje'      => $mensajeLicencia['mensaje_licencia']
                            ]);
                        ...
                        default:
                            // 👉 CUALQUIER ESTADO NUEVO O DESCONOCIDO
                            return redirect()->to(base_url('pedidos/mesas'));
                    }
                }
    ...
    function SearchInsumosRecetas()
    {
        ...
        if (!empty($productos)) {
            return $this->response->setJSON([
                ...
                'receta' => '<span class="text-primary">Componentes receta:</span> 
<span class="text-orange">' .
                    htmlspecialchars($codigo, ENT_QUOTES, 'UTF-8') . ' / ' .
                    htmlspecialchars($receta[0]['nombreproducto'], ENT_QUOTES, 'UTF-8') .
                    '</span>',
