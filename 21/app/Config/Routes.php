...
$routes->get('/crearActualizaciones', 'Login::crearActualizaciones');
$routes->post('/generarActualizacion', 'Login::crearVersion');
...
$routes->group('usuarios', ['namespace' => 'App\Controllers\usuarios', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->post('activar', 'usuariosController::activar');
});
...
$routes->group('producto', ['namespace' => 'App\Controllers\producto', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->post('reestablecerPrecio', 'ConfigurarProductoController::reestablecerPrecio');
});
...
$routes->group('clientes', ['namespace' => 'App\Controllers\cliente', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->post('clientes_autocompletadoNota', 'clienteController::clientes_autocompletadoNota');
...
$routes->group('consultas_y_reportes', ['namespace' => 'App\Controllers\consultas_y_reportes', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->get('datos_consultas_caja_por_fecha', 'reporteDeVentasController::datos_consultas_caja_por_fecha');
    ...
    $routes->post('editarAbonar', 'AbonosController::editarAbonar');
...
$routes->group('devolucion', ['namespace' => 'App\Controllers\devolucion', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->get('consultarApertura', 'RetiroController::consultarApertura');
});
...
$routes->group('empresa', ['namespace' => 'App\Controllers\empresa', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->post('validarResolucion', 'EmpresaController::validarResolucion');
...
$routes->group('caja_general', ['namespace' => 'App\Controllers\caja_general', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->post('exportFormasPagoExcel', 'cajaGeneralController::exportFormasPagoExcel');
    $routes->post('exportPedidosBorrados', 'cajaGeneralController::exportPedidosBorrados');
    $routes->post('exportProductosBorradosExcel', 'cajaGeneralController::exportProductosBorradosExcel');
...
$routes->group('pedidos', ['namespace' => 'App\Controllers\pedidos', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->post('imprimirBono', 'Imprimir::imprimirBono');
     ...
     $routes->post('actualizarCantidad', 'PartirFactura::actualizarCantidad');
...
$routes->group('inventario', ['namespace' => 'App\Controllers\pedidos', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->post('buscar_compras', 'Inventarios::buscar_compras');
});
...
$routes->group('eventos', ['namespace' => 'App\Controllers\Boletas', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->post('restablecerPrecio', 'Boletas::restablecerPrecio');
    ...
    $routes->post('consultar_compras', 'Boletas::consultar_compras');
});
...
$routes->group('reportes', ['namespace' => 'App\Controllers\reportes', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->get('exportarExcel', 'Ventas::exportarExcel');
...
$routes->group('configuracion', ['namespace' => 'App\Controllers\configuracion', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->post('actualizar_tamano', 'Configuracion::actualizar_tamano');
...
$routes->group('actualizacion', ['namespace' => 'App\Controllers\actualizaciones', 'filter' => \App\Filters\Auth::class], function ($routes) {
    ...
    $routes->get('actualizaciones', 'ActualizacionesController::index');
    $routes->post('crearVersion', 'ActualizacionesController::crearVersion');
    ...
    $routes->post('encabezadoComanda', 'ParametrizacionController::encabezadoComanda');
    $routes->post('pieComanda', 'ParametrizacionController::pieComanda');
    $routes->post('actualizar_boton_mitad', 'ParametrizacionController::actualizar_boton_mitad');
