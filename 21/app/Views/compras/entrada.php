                    ...
                    <div class="card-body ">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-4">
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" id="producto_compra" placeholder="Buscar producto" autofocus>
                            ...
                            <div class="col-2">
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control text-center" placeholder="Cantidad" value="1" onkeyup="saltar_factura_pos(event,'precio');sumarValores()" id="cantidad">
                                    <input type="text" class="form-control text-center" placeholder="Unidad de medida" id="unidadMedida" readonly>
                                </div>
                                <span id="error_cantidad" class="text-danger"></span>
                            </div>
                            ...
                            <div class="col-3">
                                <div class="row mb-2">
                                    ...
                                    <div class="col">
                                        <label class="form-label">Nuevo inventario</label>
                                        <input type="text" class="form-control" id="nuevo" readonly>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-1 d-flex align-items-end">
                                <button class="btn btn-outline-success d-flex justify-content-center align-items-center w-100" id="btnCompra" onclick="entrada_inventario()">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    success: function(resultado) {
                        ...
                        if (resultado.resultado == 1) {
                            ...
                            if (elemento) {
                                ...
                                // 🔥 Animación antes de eliminar (mejor UX)
                                $('#producto_compra' + resultado.id).fadeOut(300, function() {
                                    $(this).remove();
                                });

                                var divAEliminar = document.getElementById('linea' + resultado.id);
                                if (divAEliminar) {
                                    divAEliminar.remove();
                                }
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'Error',
                                text: resultado.mensaje || 'No se pudo eliminar'
                            });
                        }
                    },
...
<script>
    let procesandoEntrada = false; // 🔒 evita doble envío
    ...
    function entrada_inventario() {
        ...
        const codigo = document.getElementById("id_producto").value.trim();
        ...
        $.ajax({
            ...
            success: function(resultado) {
                ...
                if (data.resultado == 1) {
                    ...
                    // limpiar campos
                    $('#producto_compra, #precio, #display, #id_producto, #actual, #nuevo').val('');
    ...
    /* ======================================================
       🚀 CONTROL CORRECTO DE ENTER (SIN BUG)
    ====================================================== */
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Enter en PRECIO → guarda inventario
        if (precio) {
        ...
        $("#producto_compra").autocomplete({
            ...
            select: function(event, ui) {
                ...
                if (ui.item.id_inventario == 1 || ui.item.id_inventario == 4) {
                    ...
                    $("#unidadMedida").val(ui.item.unidad_medida); // Asigna la cantidad del producto
                    $("#cantidad").focus();
                    $("#cantidad").select();
                    $('#error_producto').html('');
