        ...
        <div class="row">
            ...
            <div class="col" style="display:none" id="cliente">
                ...
                <div class="input-group input-group-flat">
                    <input type="text" class="form-control" id="busqueda_por_cliente" name="busqueda_por_cliente">
...
<div class="modal fade" id="edicionFactura" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 text-primary" id="tituloEditarFactura">Modal title</h1>
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            <div class="input-group input-group-flat">
                                <input type="text" class="form-control" id="busqueda_de_cliente" name="buscar_cliente" placeholder="Buscar cliente por identificación o nombre">
                                <span class="input-group-text">
                                    <a href="#" class="link-secondary" title="Limpiar busqueda" data-bs-toggle="tooltip" onclick="document.getElementById('busqueda_de_cliente').value = ''"><!-- Download SVG icon from http://tabler-icons.io/i/x -->
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                            <path d="M18 6l-12 12" />
                                            <path d="M6 6l12 12" />
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-success" onclick="actualizar_factura()">Aceptar</button>
    ...
    /* async function imprimir_comprobante(id) {
        ...
        try {
            ...
            const response = await fetch(
                url + 'caja/imprimir_comprobante/' + id
            );
...
<script>
    async function editar_factura(id, id_estado) {

        try {
            const response = await fetch("<?= base_url('pedidos/editarPrefactura') ?>", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
