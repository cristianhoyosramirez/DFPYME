    ...
    <div class="card-body">
        <form action="<?= base_url('configuracion/configuracion_propina') ?>" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-4">
                    <label for="" class="form-label"> Cálculo de propina </label>
                    <select name="imprimirTexto" id="imprimirTexto" class="form-select" onchange="actualizarCalculoPropina(this.value)">
                        <option value="t" <?= ($calculoPrpina === 't') ? 'selected' : '' ?>>
                            Calcular propina sobre el total de la factura
                        </option>
                        <option value="f" <?= ($calculoPrpina === 'f') ? 'selected' : '' ?>>
                            Calcular propina sobre la base tributaria (antes de impuestos)
                        </option>
                    </select>
                ...
                <div class="col-4">
                    <label for="" class="form-label">Impresion de texto propina </label>
                ...
                <div class="col-md-4">
                    ...
                    <select id="inputState" class="form-select" name="propina" id="propina" onchange="propinaRedondeo(this.value)">
                        <option value="0" <?= ($propinaRedondeo === '0') ? 'selected' : '' ?>>Sin redondeo</option>
                        <option value="1" <?= ($propinaRedondeo === '1') ? 'selected' : '' ?>>Con redondeo</option>
                    </select>
                </div>
                <div class="col-md-4">
                    <label for="inputState" class="form-label">Permitir propina automatica en perfil mesero  </label>
                    <select id="inputState" class="form-select" name="propina" id="propina" onchange="propinaAutomatica(this.value)">
                        <option value="true" <?= ($propinaAutomatica === 't') ? 'selected' : '' ?>>Si</option>
                        <option value="false" <?= ($propinaAutomatica === 'f') ? 'selected' : '' ?>>No</option>
                    </select>
                </div>
                <div class="col-md-4">
                    <label for="inputState" class="form-label">Permitir propina manual en perfil mesero  </label>
                    <select id="inputState" class="form-select" name="propina" id="propina" onchange="propinaManual(this.value)">
                        <option value="true" <?= ($propinaManual === 't') ? 'selected' : '' ?>>Si</option>
                        <option value="false" <?= ($propinaManual === 'f') ? 'selected' : '' ?>>No</option>
                    </select>
                </div>
...
<script>
    async function propinaRedondeo(valor) {
        try {
            let baseUrl = document.getElementById("url").value;
            let url = `${baseUrl}/configuracion/propinaRedondeo`;
...
<script>
    async function propinaAutomatica(valor) {
        try {
            let baseUrl = document.getElementById("url").value;
            let url = `${baseUrl}/configuracion/propinaAutomatica`;
...
<script>
    async function propinaManual(valor) {
        try {
            let baseUrl = document.getElementById("url").value;
            let url = `${baseUrl}/configuracion/propinaManual`;
...
<script>
    async function actualizarCalculoPropina(valor) {
        try {
            let baseUrl = document.getElementById("url").value;
            let url = `${baseUrl}/configuracion/calculoPropina`;
