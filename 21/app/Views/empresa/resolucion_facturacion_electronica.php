...
<div class="container">
  <div class="row text-center align-items-center flex-row-reverse">
    ...
    <div class="col-lg-auto ms-lg-auto">
      <p class="text-primary h3">Resolución electrónica </p>
    </div>
...
<div class=" container col-md-12">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row g-2">
            ...
            <div class="col-md-3">
              <label for="inputCity" class="form-label">Consecutivo </label>
              <input type="number" class="form-control" id="consecutivo" name="consecutivo">
              <span class="text-danger" id="error_consecutivo"></span>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row g-2">
            ...
            <div class="col-md-3">
              <label for="inputCity" class="form-label">Consecutivo </label>
              <input type="number" class="form-control" id="consecutivo_edicion" name="consecutivo_edicion">
              <span class="text-danger" id="error_consecutivo_edicion"></span>
            </div>
  ...
  <script>
    function cambiar_resolucion_electronica() {
      ...
      var consecutivo = document.getElementById("consecutivo_edicion").value;
      ...
      $.ajax({
        ...
        success: function(resultado) {
          ...
          if (resultado.resultado == 1) {
            ...
            $("#consecutivo_edicion").val(resultado.consecutivo);
