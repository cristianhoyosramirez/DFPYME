                            ...
                            <div class="card-title">
                                <div class="row align-items-start">
                                    <div class="col-6">
                                        ...
                                        <p id="hora_pedido" class="text-warning "> Hora:</p>
                                    </div>
                                    <!--  <div class="col-3">
                                ...
                                <?php if ($reimpresionComanda['reimpresion_meseros'] == 't'): ?>
                                    <div class="col-md-3">
                                        <div class="btn-group w-100 d-flex" role="group">
                                            ...
                                            <a href="#" class="btn btn-outline-secondary flex-fill" onclick="reimprimir_comanda()" title="Reimprimir comanda">
                                                <!-- Ícono SVG -->
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                                                    stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
                                                    stroke-linejoin="round">
...
<script>
        ...
        $.ajax({
            ...
            success: function(resultado) {
                ...
                if (resultado.resultado == 1) {
                    ...
                    resultado.mesas.forEach(function(mesa) {
                        ...
                        if (mesa.ocupada == true) {
                            ...
                            let total =
                                parseFloat(mesa.valor_total || 0) +
                                parseFloat(mesa.propina || 0);
                            ...
                            let textoMostrado =
                                textoBase.length > 10 ?
                                textoBase.substring(0, 10) + '...' :
                                textoBase;

                            color = 'bg-red-lt';
                            imagen = 'ocupada.png';
                            accion = `pedido_mesa('${mesa.id}','${mesa.nombre}')`;
                        ...
                        `;
                            ...
                            color = 'bg-green-lt';
                            imagen = 'libre.png';
                            accion = `pedido('${mesa.id}','${mesa.nombre}')`;
                        }

                        let html = `
                    <div id="mesa${mesa.id}"
                        class="cursor-pointer card card_mesas text-white ${color}"
                        onclick="${accion}"
                        style="height:auto;">
    ...
    // Cada 5 segundos
    setInterval(actualizar_mesas_pedido, 5000);
</script>
...
<script>
    function calcularPropina(propina) {
        ...
        if (criterio_propina == 1) {
            ...
            calcular_propina_movil(valor_propina)
...
<script>
    function calcular_propina_movil(valor_propina) {
        ...
        $.ajax({
            ...
            success: function(resultado) {
                ...
                if (resultado.resultado == 1) {
                    ...
                    document.getElementById('propina_movil').value = resultado.propina
