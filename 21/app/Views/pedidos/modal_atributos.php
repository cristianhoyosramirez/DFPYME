  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="id_tabla_producto" placeholder="id tabla producto">
...
<script>
  function cerrarModalAtributos() {
    ...
    // limpiar arreglo global y re-renderizar
  ...
  async function addOtherProduct() {
    try {
      ...
      /*   if (data.response == "success") {
          ...
          document.getElementById("hora_pedido").innerHTML = data.hora
          ...
          const Toast = Swal.mixin({
            ...
            showCloseButton: true, // 👈 Agrega la "X"
            timer: 1000,
            timerProgressBar: false, // 👈 Elimina la barra de progreso
            didOpen: (toast) => {
          ...
          Toast.fire({
            ...
            title: 'Agregado',
            customClass: {
              popup: 'centered-toast' // Puedes usar esto para agregar estilos adicionales si lo deseas
            }
          });
      ...
      if (data.response == "success") {
        ...
        // limpiar componentes
        componentesSeleccionados.length = 0; // 👈 vacía el arreglo en memoria
        document.getElementById("inputComponentes").value = "";
        document.getElementById("notaAtributo").value = "";
        document.getElementById("contenedorBotonesComponentes").innerHTML = "";
        renderizarBotonesComponentes(); // 👈 asegura que se refresque la vista
...
<script>
  ...
  async function addOtherProduct() {
    ...
    const boton = document.getElementById('btnAtri');
    boton.disabled = true;
    ...
    Swal.fire({
      title: 'Procesando...',
      text: 'Agregando producto al pedido',
    ...
    try {
      ...
      if (data.response === "success") {
        ...
        if (typeof renderizarBotonesComponentes === 'function') {
          renderizarBotonesComponentes();
        }
        ...
        Swal.fire({
          icon: 'warning',
          title: 'Aviso',
          text: data.mensaje || 'No fue posible agregar el producto.'
        });
      ...
      Swal.fire({
        icon: 'error',
        title: 'Error',
        text: 'No fue posible agregar el producto. Intente nuevamente.'
      });
