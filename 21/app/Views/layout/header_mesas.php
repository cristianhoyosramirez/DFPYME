  ...
  <div class="container-xl">
    ...
    <div class="collapse navbar-collapse" id="navbar-menu">
      <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
        <ul class="navbar-nav">
          <li class="nav-item active dropdown  <?= service('request')->uri->getPath() == '' ? 'is_active' : '' ?>">
            <?php if ($user_session->tipo == 0) { ?>
              <a class="nav-link dropdown-toggle" href="<?= base_url() ?>/edicion_eliminacion_factura_pedido/menu">
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item text-green" href="<?= base_url() ?>/actualizacion/actualizaciones">
                ...
                <a class="dropdown-item " href="<?= base_url() ?>/configuracion/version">
                  <!-- Download SVG icon from http://tabler-icons.io/i/versions -->
                  <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <a class="dropdown-item " href="<?= base_url() ?>/configuracion/tipos_inventario">
        ...
        <?php if ($user_session->tipo == 0 || $user_session->tipo == 1 || $user_session->tipo == 2 || $user_session->tipo == 3 || $user_session->tipo == 5 || $user_session->tipo == 4) { ?>
          <li class="nav-item dropdown">
                ...
                <?php if ($user_session->tipo == 0 || $user_session->tipo == 1  || $user_session->tipo == 5 || $user_session->tipo == 4) { ?>
                  ...
                  <div class="dropdown-menu">
                    ...
                    <?php if ($user_session->tipo == 0 || $user_session->tipo == 5) { ?>
                      <a class="dropdown-item" href="<?= base_url() ?>/consultas_y_reportes/datos_consultas_caja_por_fecha">
                        <!-- Download SVG icon from http://tabler-icons.io/i/question-mark -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                          <path d="M8 8a3.5 3 0 0 1 3.5 -3h1a3.5 3 0 0 1 3.5 3a3 3 0 0 1 -2 3a3 4 0 0 0 -2 4" />
                ...
                <div class="dropend">
                  ...
                  <?php if ($user_session->tipo == 0 || $user_session->tipo == 1 || $user_session->tipo == 4 || $user_session->tipo == 5) { ?>
                    <a href="<?= base_url() ?>/eventos/consultar_ventas" class="dropdown-item">
                      ...
                      Consultar ventas </a>
                    <a href="<?= base_url() ?>/reportes/notas_credito" class="dropdown-item">
                      <!-- Download SVG icon from http://tabler-icons.io/i/checkup-list -->
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2" />
              ...
              <div class="dropend">
                ...
                <div class="dropdown-menu">
                  ...
                  <a href="<?= base_url() ?>/reportes/reporte_costo" class="dropdown-item">
                    ...
                    </svg>De Costo x factura </a>
                  <a href="<?= base_url() ?>/factura_directa/reporteCosto" class="dropdown-item">
                  ...
                  <a href="<?= base_url() ?>/factura_directa/formas_pago" class="dropdown-item">
                  ...
                  <a href="<?= base_url() ?>/reportes/reporteUsuario" class="dropdown-item">
                    <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                      <circle cx="12" cy="7" r="4" />
