<style id="select2style">
    ...
    #miListaClientes {
        ...
        width: 100%;
        /* 👈 clave para que no ocupe toda la pantalla */
...
<ul id="miListaClientes" class="custom-select2-list">
    <?php foreach ($clientes as $cliente): ?>
        <li onclick="seleccionarCliente(
        <?= $cliente['id'] ?>,
        '<?= addslashes($cliente['nitcliente'] . ' - ' . $cliente['nombrescliente']) ?>',
        '<?= addslashes($cliente['telefonocliente']) ?>'
    )">
