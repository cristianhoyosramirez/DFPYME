...
header("Expires: 0");
$filename = "Reporte de ventas .xls"; // Cambiado para reflejar un nombre de archivo sin espacios
...
<table class="table" style="border-collapse: collapse; width: 100%;">
    <thead>
        <tr>
            ...
            <th style="border: 1px solid #000; background-color: black; color: white;">ICO</th>
...
<table class="table">
    <thead>
        <tr>
           ...
           <td style="border: 1px solid #000; background-color: black; color: white;">Total IVA: <?php echo $total_iva ?> </th>
           ...
           <td style="border: 1px solid #000; background-color: black; color: white;">Total base: <?php echo $total_base ?> </th>
