...
<div class=" container col-md-12">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <input type="time" id="hora_inicial" name="hora_inicial" class="form-control" value="<?php echo date("H:i"); ?>">
                ...
                <div class="col">
                    ...
                    <input type="time" id="hora_final" name="hora_final" class="form-control" value="<?php echo date("H:i"); ?>">
                ...
                <div class="col text-end" style="display: flex; justify-content: flex-end; align-items: end;">
                    ...
                    &nbsp;&nbsp;
                    <form action="<?= base_url('caja/exportar_a_excel_reporte_categorias') ?>" method="POST" id="frmExportExcel">
                        <input type="text" id="fechaInicial" hidden name="fechaInicial">
                        <input type="text" id="fechaFinal" hidden name="fechaFinal">
                        <input type="text" id="horaInicial" hidden name="horaInicial">
                        <input type="text" id="horaFinal" hidden name="horaFinal">
                        <button type="button" class="btn btn-outline-success btn-icon" onclick="Excel()">Excel</button>
                    </form>
                </div>
    ...
    <script>
        function Excel() {
            fechaInicial = document.getElementById('fecha_inicial').value;
            document.getElementById('fechaInicial').value = fechaInicial;

            horaInicial = document.getElementById('hora_inicial').value;
            document.getElementById('horaInicial').value = horaInicial;
            ...
            document.getElementById('horaFinal').value = horaInicial;



            document.getElementById('frmExportExcel').submit();
