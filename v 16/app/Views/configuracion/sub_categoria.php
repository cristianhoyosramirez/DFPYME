...
<div class="container">
    <div class="row text-center align-items-center flex-row-reverse">
        ...
        <div class="col-lg-auto ms-lg-auto">
            <p class="text-primary h3">Lista de categorías y subcategorías </p>
        </div>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr class="table-primary">
                        ...
                        <td><?php echo " Categoría: " . $nombre_categoria['nombrecategoria']  ?></td>
                        <td></td>
                    </tr>
                ...
                <div id="operaciones">
                    <form class="row g-3" action="<?= base_url('categoria/sub_categoria') ?>" method="POST" id="crear_categoria">
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="" class="form-label">Nombre sub categoría </label>
