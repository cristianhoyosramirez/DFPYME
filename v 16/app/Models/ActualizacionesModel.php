...
-- ===========================
-- Updates a medios_pago
-- ===========================
UPDATE medios_pago SET nombre = 'Instrumento no definido ', activo = FALSE, descripcion = 'INSTRUMENTO NO DEFINIDO' WHERE id = 1;
UPDATE medios_pago SET nombre = 'CASH', activo = TRUE, descripcion = 'EFECTIVO' WHERE id = 10;
UPDATE medios_pago SET nombre = 'Reversión Crédito Ahorro ', activo = FALSE, descripcion = 'REVERSIÓN CRÉDITO AHORRO' WHERE id = 11;
UPDATE medios_pago SET nombre = 'Reversión Débito Ahorro ', activo = FALSE, descripcion = 'REVERSIÓN DÉBITO AHORRO' WHERE id = 12;
UPDATE medios_pago SET nombre = 'Crédito Ahorro ', activo = FALSE, descripcion = 'CRÉDITO AHORRO' WHERE id = 13;
UPDATE medios_pago SET nombre = 'Débito Ahorro ', activo = FALSE, descripcion = 'DÉBITO AHORRO' WHERE id = 14;
UPDATE medios_pago SET nombre = 'Bookentry Crédito ', activo = FALSE, descripcion = 'BOOKENTRY CRÉDITO' WHERE id = 15;
UPDATE medios_pago SET nombre = 'Bookentry Débito ', activo = FALSE, descripcion = 'BOOKENTRY DÉBITO' WHERE id = 16;
UPDATE medios_pago SET nombre = 'Crédito Pago negocio corporativo (CTP) ', activo = FALSE, descripcion = 'CRÉDITO PAGO NEGOCIO CORPORATIVO (CTP)' WHERE id = 19;
UPDATE medios_pago SET nombre = 'Crédito ACH ', activo = FALSE, descripcion = 'CRÉDITO ACH' WHERE id = 2;
update comfiguracion_pedido set codigo_pantalla= 'false';
