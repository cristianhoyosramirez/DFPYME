function prefactura(id) {
    ...
    var impresionOp = document.getElementById("configuracionOrden").value;



    if (impresionOp == 'f') {  //Cuando impresionOp  es t quiere decir que es verdadero e imprime derecho 
    ...
    } else if (impresionOp == 't') {


        $("#modalConfOp").modal("show");
